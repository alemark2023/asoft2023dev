...
<head>
    ...
    <title>REPORTE PRODUCTOS HISTORIAL</title>
    <style>
        html {
...
@if(!empty($records))
    <div class="">
        <div>
            <h1 align="center" class="title">REPORTE GENERAL PRODUCTO VENTAS HISTORIAL</h1>
            <h2 align="center">{{ $name }}</h2>
            <h3 align="center">{{ $document_type.': '.$number }}</h3>
        </div>
        <div class=" ">
            <table class="" style="table-layout:fixed;">
                ...
                ?>
                <tr width="100%">
                    @include('report::general_items.partials.report_pdf_history_header',[
                ...
                @if($type == 'sale')
                    @if($document_type_id == '80')
                        @foreach($records as $key => $value)
                            ...
                            ?>
                            @include('report::general_items.partials.report_pdf_history_body_sale',[
                                      'document_type_id'=>$document_type_id,
                                      'document'=>$document,
                                      'type'=>$type,
                                      'value'=>$value,
