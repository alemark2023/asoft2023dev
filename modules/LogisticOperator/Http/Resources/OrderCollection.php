<?php
    ...
    namespace Modules\LogisticOperator\Http\Resources;
        ...
        public function toArray($request)
        {
            ...
            return $this->collection->transform(function ($row, $key) {
                return [
                    ...
                    'test_embarque' => route('test.yobel.embarque',['id'=>$row->id]),
                    'test_cliente' => route('test.yobel.cliente',['id'=>$row->id]),
                    'test_pedido' => route('test.yobel.pedido',['id'=>$row->id]),
                ];
            });
