<?php
    ...
    use App\Models\Tenant\Module as TenantModule;
    use Carbon\Carbon;
    use Exception;
    ...
    use Modules\LevelAccess\Models\ModuleLevelUser as TenantModuleLevelUser;
    use Modules\LevelAccess\Models\ModuleUser as TenantModuleUser;
    ...
    private function prepareModules(Module $module): Module
    {
        ...
        {
            /**
             * @var TenantModule $modules
             * @var TenantModule $apps
             * @var TenantModuleUser modules
             * @var TenantModuleUser apps
             * @var TenantModuleLevelUser levels
             * @var TenantConfig $config
             * @var TenantCompany      $company
             */
