...
class TenantModuleLevelsTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('module_levels')->insert([
            ...
            ['value' => 'items', 'description' => 'Productos', 'module_id' => 1],
            ['value' => 'categories', 'description' => 'Categorías', 'module_id' => 1],
            ['value' => 'brands', 'description' => 'Marcas', 'module_id' => 1],
            ['value' => 'customers', 'description' => 'Clientes', 'module_id' => 1],
            ['value' => 'summaries', 'description' => 'Resúmenes', 'module_id' => 1],
            ['value' => 'voided', 'description' => 'Anulaciones', 'module_id' => 1],
