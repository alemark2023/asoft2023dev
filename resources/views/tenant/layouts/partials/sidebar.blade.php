            ...
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                   <!-- <li class="{{ ($path[0] === 'ecommerce')?'nav-active':'' }}">
                    ...
                    <li class="nav-parent {{  ($path[0] === 'reports' && in_array($path[1], ['purchases', 'search','sales','customers','consistency-documents', 'quotations', 'sale-notes','cash','commissions','document-hotels', 'validate-documents', 'document-detractions'])) ? 'nav-active nav-expanded' : ''}}">
                        <a class="nav-link" href="#">
