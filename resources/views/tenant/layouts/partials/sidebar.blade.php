...
// echo "<pre>";print_r($vc_modules);print_r($vc_module_levels);die('FUCK YOU');
?>
        ...
        <div class="nano-content">
            <nav id="menu"
                ...
                <ul class="nav nav-main">
                    ...
                    {{-- Salud --}}
                    @if(in_array('salud', $vc_modules))
                        <li class="nav-parent
                        {{ $firstLevel === 'salud' ? 'nav-active nav-expanded':'' }}
                        {{ $firstLevel === 'atenciones' ? 'nav-active nav-expanded' : '' }}
                        {{ $firstLevel === 'citas' ? 'nav-active nav-expanded' : '' }}
                        {{ $firstLevel === 'pacientes' ? 'nav-active nav-expanded' : '' }}
                        {{ $firstLevel === 'maestros' ? 'nav-active nav-expanded' : '' }}
                            ">
                            <a class="nav-link"
                               href="#">
                            ...
                            <ul class="nav nav-children">
                                @if(in_array('atenciones', $vc_module_levels))
                                    <li class="{{ ($firstLevel === 'salud' && $secondLevel === 'atenciones')?'nav-active':'' }}">
                                        <a class="nav-link" href="">Atenciones</a>
                                    </li>
                                @endif
                                @if(in_array('citas', $vc_module_levels))
                                    <li class="{{ ($firstLevel === 'citas')?'nav-active':'' }}">
                                        <a class="nav-link" href="">Citas</a>
                                    </li>
                                @endif
                                @if(in_array('pacientes', $vc_module_levels))
                                    <li class="{{ ($firstLevel === 'salud' && $secondLevel === 'customers')?'nav-active':'' }}">
                                        <a class="nav-link" href="{{ route('tenant.patients.patient', ['type' => 'customers']) }}">Pacientes</a>
                                    </li>
                                @endif
                                @if(in_array('medicos', $vc_module_levels))
                                    <li class="{{ ($firstLevel === 'maestros')?'nav-active':'' }}">
                                        <a class="nav-link" href="">Medicos</a>
                                    </li>
                                @endif
                                @if(in_array('especialidades', $vc_module_levels))
                                    <li class="{{ ($firstLevel === 'salud' && $secondLevel === 'specialty') ?'nav-active':'' }}">
                                        <a class="nav-link" href="{{ route('tenant.salud.specialty') }}">Especialidades</a>
                                    </li>
                                @endif
                                @if(in_array('turnos', $vc_module_levels))
                                    <li class="{{ ($firstLevel === 'maestros')?'nav-active':'' }}">
                                        <a class="nav-link" href="">Turnos</a>
                                    </li>
                                @endif
                                @if(in_array('horarios', $vc_module_levels))
                                    <li class="{{ ($firstLevel === 'maestros')?'nav-active':'' }}">
