            ...
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    ...
                    @if(auth()->user()->type != 'integrator')
                        ...
                        {{ ($path[0] === 'pos' && $path[1] === 'fast')?'nav-active nav-expanded':'' }}
                        ">
                            <a class="nav-link" href="#">
                            ...
                            <ul class="nav nav-children">
                                ...
                                <li class="{{ ($path[0] === 'pos' && $path[1] === 'fast')?'nav-active':'' }}">
                                    <a class="nav-link" href="{{route('tenant.pos.fast')}}">Venta rápida</a>
                                </li>
                                @endif
                                @if(in_array('pos', $vc_module_levels))
                                <li class="{{ ($path[0] === 'pos' && $path[1] === '' )?'nav-active':'' }}">
