<template>
    <el-dialog width="65%" :title="titleDialog" :visible="showDialog" :close-on-click-modal="false" @close="close" @open="create" append-to-body top="7vh" class="pt-0">
            ...
            <el-tabs v-model="activeName">
                                        ...
                                        <tr>
                                            <td>
                                                <div v-show="form.has_perception">
                                                    <div class="form-group"  >
                                                        <el-input placeholder="% de percepción" v-model="form.percentage_perception"></el-input>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div v-show="form.unit_type_id !='ZZ' && form.lots_enabled">
                                                    <div class="form-group" :class="{'has-danger': errors.lot_code}">
                                                        <el-input placeholder="Código de lote" v-model="form.lot_code"></el-input>
                                            ...
                                            <td>
                                                <div v-show="form.unit_type_id !='ZZ' && form.series_enabled && !recordId">
                                                    <div class="form-group" :class="{'has-danger': errors.lot_code}">
                                                        <el-button size="small" type="primary" icon="el-icon-edit-outline"  @click.prevent="clickLotcode">Ingrese series</el-button>
                                                        <small class="form-control-feedback" v-if="errors.lot_code" v-text="errors.lot_code[0]"></small>
                                                    </div>
                                                </div>
                                            </td>
                ...
                <el-tab-pane class name="third">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <a href="#" class="control-label font-weight-bold text-info" @click="clickAddRow"> [ + Agregar]</a>
                        </div>
                    </div>
                </el-tab-pane>
                ...
                <el-tab-pane class name="five">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 center-el-checkbox pt-2"  v-show="purchase_show_has_igv">
                        ...
                        <div class="col-md-4 center-el-checkbox pt-2">
                            <div class="form-group">
                                <el-checkbox v-model="enabled_percentage_of_profit" @change="changeEnabledPercentageOfProfit">Aplica ganancia</el-checkbox><br>
                            </div>
                        </div>
